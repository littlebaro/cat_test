...
<template>
    ...
    <div class="flex h-77px md:h-105px md:pl-40px md:gap-60px items-center md:justify-end justify-between duration-500 sticky top-0 relative">

        <div class="md:hidden flex w-82px h-61px px-24px py-8px md:m-40px text-41px text-white font-bold items-center">CAT</div>

        <div class="hidden lg:flex gap-55px text-center bg-#ffffff/40% p-20px rounded-50px"> 
